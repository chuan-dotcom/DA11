    ...
    <form method="POST" action="{{ route('hdv/nhat-ky-tour/store') }}" enctype="multipart/form-data">
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select name="departure_id" class="form-select" required>
                    ...
                    @foreach($departures as $d)
                        <option value="{{ $d['id'] }}" {{ isset($selectedDepartureId) && $selectedDepartureId == $d['id'] ? 'selected' : '' }}>
            ...
            <div class="col-12">
                ...
                <input type="text" name="title" class="form-control" placeholder="Ví dụ: Ngày 1: Đón đoàn tại sân bay và di chuyển về khách sạn..." required>
            </div>

            <!-- Thời tiết & Tâm trạng -->
            <div class="col-md-6">
                <label class="form-label fw-bold">Thời tiết trong ngày</label>
                <input type="text" name="weather" class="form-control" placeholder="Nắng nhẹ, Nắng mát, Mưa rào...">
            </div>

            <div class="col-md-6">
                <label class="form-label fw-bold">Tâm trạng / Không khí đoàn</label>
                <input type="text" name="mood" class="form-control" placeholder="Hào hứng, Vui vẻ, Mệt mỏi nhẹ...">
            </div>

            <!-- Nội dung chi tiết -->
            <div class="col-12">
                <label class="form-label fw-bold">Nội dung nhật ký chi tiết <span class="text-danger">*</span></label>
                <textarea name="content" class="form-control" rows="6" placeholder="Ghi chép tình hình đoàn, tiến độ lịch trình, sự cố nếu có..." required></textarea>
            </div>
