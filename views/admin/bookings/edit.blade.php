        ...
        <div class="card-body">
            <form action="{{ route('admin/bookings/update/' . $booking['id']) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pickup_address" class="form-control" value="{{ isset($_POST['pickup_address']) ? htmlentities($_POST['pickup_address']) : ($booking['pickup_address'] ?? '') }}" placeholder="Ví dụ: Số 123 đường Nguyễn Huệ, Q.1, TP.HCM">
                </div>
