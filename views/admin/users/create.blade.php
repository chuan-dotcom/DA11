    ...
    <nav aria-label="breadcrumb" class="mb-3 uf-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <i class="bi bi-person-plus me-1"></i>{{ $title }}
            </li>
        </ol>
    </nav>
        ...
        <div class="uf-card">
            <div class="uf-card-head">
                <h3 class="uf-card-title">
                    <i class="bi bi-person-plus-fill me-1"></i> Thông tin tài khoản mới
                </h3>
                <div class="uf-actions">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill">
                        <i class="bi bi-save-fill me-1"></i> Lưu tài khoản
                    </button>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-8">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="password" class="form-label uf-form-label">
                                ...
                                <div class="uf-hint mt-1">Sử dụng mật khẩu mạnh, kết hợp chữ, số và ký tự đặc biệt.</div>
                            </div>

                            <div class="col-md-6">
                                <label for="password_confirmation" class="form-label uf-form-label">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mt-3">
                            ...
                            <select class="form-select uf-form-select" id="role" name="role" required>
                                <option value="user" {{ old('role', 'user') === 'user' ? 'selected' : '' }}>Người dùng</option>
                                <option value="hdv" {{ old('role') === 'hdv' ? 'selected' : '' }}>Hướng dẫn viên</option>
                                <option value="admin" {{ old('role') === 'admin' ? 'selected' : '' }}>Quản trị viên</option>
                            </select>
                        </div>

                        <div class="mt-3 d-none" id="hdvWrap">
                            ...
                            <select class="form-select uf-form-select" id="hdv_id" name="hdv_id">
                                ...
                                @foreach($staffs as $staff)
                                    <option value="{{ $staff['HDV_id'] }}" {{ (string) old('hdv_id') === (string) $staff['HDV_id'] ? 'selected' : '' }}>
                        ...
                        <div class="mt-3">
                            ...
                            <select class="form-select uf-form-select" id="status" name="status" required>
                                <option value="1" {{ (string) old('status', '1') === '1' ? 'selected' : '' }}>Hoạt động</option>
                                <option value="0" {{ (string) old('status') === '0' ? 'selected' : '' }}>Khóa</option>
                            </select>
                        </div>
                    </div>
                </div>
