...
class TourCategoryController extends Controller{
    ...
    public function index() {
        ...
        return view('admin.tour-categories.index', compact('title', 'categories'));
    }

    public function create() {
        $title = 'Thêm mới danh mục tour';
        return view('admin.tour-categories.create', compact('title'));
    }
    ...
    public function edit($id) {
        ...
        return view('admin.tour-categories.edit', compact('title', 'category'));
    }
