...
$router->get('admin/tour-logs', TourLogController::class . '@index');
$router->get('admin/tour-logs/create', TourLogController::class . '@create');
$router->post('admin/tour-logs/store', TourLogController::class . '@store');
$router->get('admin/tour-logs/show/(\d+)', TourLogController::class . '@show');
$router->get('admin/tour-logs/edit/(\d+)', TourLogController::class . '@edit');
$router->post('admin/tour-logs/update/(\d+)', TourLogController::class . '@update');
$router->get('admin/tour-logs/delete/(\d+)', TourLogController::class . '@delete');
